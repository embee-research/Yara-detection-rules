...
rule qakbot_api_hashing
{
	...
	strings:
		...
		$qakbot_stringblock = {00 00 00 00 64 10 b7 1d c8 20 6e 3b ac 30 d9 26 90 41 dc 76 f4 51 6b 6b 58 61 b2 4d 3c 71 05 50 20 83 b8 ed 44 93 0f f0 e8 a3 d6 d6 8c b3 61 cb b0 c2 64 9b d4 d2 d3 86 78 e2 0a a0 1c f2 bd bd}
